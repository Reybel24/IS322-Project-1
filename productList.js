(function () {
    ...
    var mockDatabase = [
        ...
        { _id: 'airheads', name: 'AirHeads Xtremes Bites', price: '14.99', description: 'These are airheads.', brand: 'Other', year: '1985', flavor: 'sweet', nuts: 'no', descriptionLong: "<h2>Airheads</h2><p>AirHeads are a tangy, <b>taffy-like</b>, chewy candy manufactured by Dutch-Italian company Perfetti Van Melle in Erlanger, Kentucky.[1] They were created August 7, 1985 by <b>Steve Bruner</b>.[2] AirHeads are available nationwide in the United States. The candy is available in over 16 different flavors. </p>" },
        { _id: 'york_peppermint', name: 'York Peppermint Patties', price: '8.99', description: 'These are york pepopermints.',brand: 'The Hershey Company', year: '1975', flavor: 'mint', nuts: 'no', descriptionLong: "<h2>York Peppermint</h2><p>York Peppermint Pattie is a <b>dark chocolate</b> enrobed peppermint confection produced by The Hershey Company. </p>" },
